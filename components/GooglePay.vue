...
function onPaymentDataChanged(intermediatePaymentData:any) {
  return new Promise(function(resolve, reject) {
...
function calculateNewTransactionInfo(shippingOptionId:any) {
  let newTransactionInfo:any = getGoogleTransactionInfo();

  let shippingCost:any = getShippingCosts()[shippingOptionId];
...
onMounted(() => {
  ...
  script.onload = () => {
    if (typeof onGooglePayLoaded === 'function') {
      ...
      console.warn('onGooglePayLoaded is not defined')
    }
  }
